      ...
      <div class="container" style="background-image: url('images/ybg.jpg');background-repeat: no-repeat; background-size: 100% 100%;"> 
				...
				<div class='list-group gallery'>
					...
					<div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
						<a class="thumbnail fancybox" rel="ligthbox" href="images/coupons/4offpizza.gif">
							<img class="img-responsive" alt="" src="images/coupons/4offpizza.gif" />
							<div class='text-right'>
								<small class='text-muted'>$4 off any order $30 or more</small>
							</div> <!-- text-right / end -->
						</a>
					</div> <!-- col-6 / end -->
					
					<div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
						<a class="thumbnail fancybox" rel="ligthbox" href="images/coupons/9offpizza.gif">
							<img class="img-responsive" alt="" src="images/coupons/9offpizza.gif" />
							<div class='text-right'>
								<small class='text-muted'>$9 off any order $60 or more</small>
							</div> <!-- text-right / end -->
						</a>
					</div> <!-- col-6 / end -->
					
					<div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
						<a class="thumbnail fancybox" rel="ligthbox" href="images/coupons/4offspecialtypizza.gif">
							<img class="img-responsive" alt="" src="images/coupons/4offspecialtypizza.gif" />
							<div class='text-right'>
								<small class='text-muted'>$4 off A large 16" Specialty Pizza</small>
							</div> <!-- text-right / end -->
						</a>
					</div> <!-- col-6 / end -->
					
					<div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
						<a class="thumbnail fancybox" rel="ligthbox" href="images/coupons/freepizza.gif">
							<img class="img-responsive" alt="" src="images/coupons/freepizza.gif" />
							<div class='text-right'>
								<small class='text-muted'>Free Pizza</small>
							</div> <!-- text-right / end -->
						</a>
					</div> <!-- col-6 / end -->
					
					<div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
						<a class="thumbnail fancybox" rel="ligthbox" href="images/coupons/june2.gif">
							<img class="img-responsive" alt="" src="images/coupons/june2.gif" />
							<div class='text-right'>
								<small class='text-muted'>Free 2-Liter Bottle of Soda</small>
							</div> <!-- text-right / end -->
						</a>
					</div> <!-- col-6 / end -->
					
					<div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
						<a class="thumbnail fancybox" rel="ligthbox" href="images/coupons/pizzacoupon.gif">
							<img class="img-responsive" alt="" src="images/coupons/pizzacoupon.gif" />
							<div class='text-right'>
								<small class='text-muted'>Wacky Week night</small>
							</div> <!-- text-right / end -->
						</a>
					</div> <!-- col-6 / end -->
