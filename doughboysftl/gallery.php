      ...
      <div class="container" style="background-image: url('images/ybg.jpg');background-repeat: no-repeat; background-size: 100% 100%;"> 
				...
				<?php
					...
					while($row = mysqli_fetch_array($rs)) {
						if (file_exists("images/categories/" . $row["id_categoria"] . ".jpg")) {
						?>
						<div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
							<a class="thumbnail fancybox" rel="ligthbox" href="images/categories/<?php echo $row["id_categoria"]; ?>.jpg">
								<img class="img-responsive" alt="" src="images/categories/<?php echo $row["id_categoria"]; ?>.jpg" />
